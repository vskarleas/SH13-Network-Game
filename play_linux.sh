...
PURPLE='\033[1;35m'
YELLOW='\033[0;33m'
NORMAL='\033[0m'  # Define NORMAL as reset (in ANSI)
...
if [[ -n "$input" ]]; then
  ...
  echo -e "${BLUE}NOTE:${NORMAL} You have the option to play either on 3 or 4 people. You are asked to choose which mode you wish below. More details about the game and its implementation at https://github.com/vskarleas/ROB4-S7-SH13.\n"
  echo -e "++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
